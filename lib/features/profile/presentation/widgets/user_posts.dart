import 'package:blog_application_aastu_grp3/features/article/presentation/pages/edit_article_body.dart';
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () {
                        // link it with detail page .
                       Navigator.push(context, MaterialPageRoute(builder: (context) => EditArticleBody(article: posts[index])));
                      },
                      child: PostCard(
