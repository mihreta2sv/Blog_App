...
class EditArticleBody extends StatefulWidget {
  const EditArticleBody({required this.article ,super.key});
  final Articles article;

  @override
  State<EditArticleBody> createState() => _EditArticleBodyState();
}

class _EditArticleBodyState extends State<EditArticleBody> {
  ...
  Widget build(BuildContext context) {
    ...
    _taskTitleController.text = widget.article.title!;
    _taskSubTitleController.text = widget.article.subTitle!;
    _taskTagController.text = widget.article.tags!.first;
    _taskContentController.text = widget.article.content!;
    categories = widget.article.tags!;
        ...
        body: BlocConsumer<AddArticleBloc, AddArticleState>(
          listener: (context, state) {
            if (state is AddArticleFailed) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text("Article Succesfully Edited!")));
